 ...
 * @author GABRIEL
 */
public class Consultae extends javax.swing.JFrame {

    /**
     * Creates new form Consultae
     */
    public Consultae() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Consultae.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
